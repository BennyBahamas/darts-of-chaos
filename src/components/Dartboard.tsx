...
// Input is still done with the dropdowns in DartInput; this is display-only.
// ============================================================================

// Standard dartboard order, clockwise from 20 at the top.
const ORDER = [20, 1, 18, 4, 13, 6, 10, 15, 2, 17, 3, 19, 7, 16, 8, 11, 14, 9, 12, 5];
const WEDGE = 360 / 20; // 18°
...
type Ring = "S" | "D" | "T" | "OB" | "IB";

function ringRadii(ring: Ring): [number, number] {
  switch (ring) {
    case "S":
...
function parseSegment(seg: string): { ring: Ring; number: number | null } | null {
